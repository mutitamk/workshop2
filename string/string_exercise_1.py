...
# จงเขียนคำสั่งเพื่อแสดงข้อความ "Python is one of the fastest-growing programming languages" ให้เป็นตัวพิมใหญ่ทั้งหมด
string = "Python is one of the fastest-growing programming languages"
print(string.upper())

# จงเขียนคำสั่งเพื่อแสดงข้อความ "Python is one of the fastest-growing programming languages" ให้เป็นตัวพิมเล็กทั้งหมด
string = "Python is one of the fastest-growing programming languages "
print(string.lower())

# จงเขียนคำสั่งเพื่อแสดงข้อความ "Python is one of the fastest-growing programming languages" ที่ถูกแทนที่อักษร r ด้วย x ทั้งหมด
string = "Python is one of the fastest-growing programming languages"
